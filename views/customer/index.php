    ...
    <header>
        ...
        <nav class="navbar">
            <header class="nabvar-mobile is-size-5-mobile">
                ...
                <a class="navbar-mobile-link has-text-white" href="index.html">Online Boutique</a>
            ...
            <nav class="nav-menu --nav-dark-light" id="mySidenav">
                ...
                <ul class="nav-menu-ul">
                    <li class="nav-menu-item" id="men">
                        <a class="nav-menu-link link-submenu" href="departamentocaballeros.php">Hombre <i
                    ...
                    <li class="nav-menu-item" id="women">
                        <a href="departamentocaballeros.php" class="nav-menu-link link-submenu">Mujer <i class="zmdi zmdi-chevron-down"></i> </a>
                        <div class="container-sub-menu">
...
<?php
    ...
    if($conexion)
    {
         ...
         $mostrarprendas="SELECT id_Prenda,  precio, cantidad, id_Marca,  id_Talla,  id_Departamento, id_Proveedor, img_prenda,tipo_img from prenda order by cantidad desc";
         ...
         if($filas)
             {
                 ...
                 while($columnas=mysqli_fetch_assoc($filas))
                 {
                  ...
                  echo'   <div class="card">';
                   ...
                   echo'      <img src="../../img/bd.png" alt="">';  //data:image/'.$tipo.';base64,'.base64_encode($columnas['img_prenda']).'
