...
<head>
    ...
    <title>Departamento de caballeros</title>
</head>
...
<body>
            ...
            <nav class="nav-menu --nav-dark-light" id="mySidenav">
                ...
                <ul class="nav-menu-ul">
                    <li class="nav-menu-item" id="men">
                        <a class="nav-menu-link link-submenu" href="depatametocaballeros.php">Hombre <i
                    ...
                    <li class="nav-menu-item" id="women">
                        <a href="departamentodamas.php" class="nav-menu-link link-submenu">Mujer <i class="zmdi zmdi-chevron-down"></i> </a>
                        <div class="container-sub-menu">
   ...
   <div class="banner banner-second">
        <div class="banner-container ">
            <h1>Departamento de Caballeros</h1>
...
<?php
    ...
    if($conexion)
    {
            ...
            $mostrarprendas="SELECT id_Prenda,  precio, cantidad, id_Marca,  id_Talla,  id_Departamento, id_Proveedor, img_prenda from prenda WHERE id_Departamento=2 order by cantidad desc";
